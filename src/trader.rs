                ...
                Ok(response) => {
                    ...
                    loop {
                        ...
                        if elapsed >= max_wait_seconds {
                            crate::log_println!("   ⏱️  Maximum wait time ({}) seconds reached", max_wait_seconds);
                            break;
                        }
                        ...
                        match self.api.check_balance_allowance(&opportunity.token_id).await {
                            Ok((balance, _allowance)) => {
                                ...
                                crate::log_println!("   ✅ Balance check (attempt {}, {}s elapsed): {:.6} shares", attempt, elapsed, balance_f64);
